        ...
        <div class="col-sm-offset-1 col-sm-10">
          <div class="panel">
            ...
            <div class="panel-body">
              <form action="sendRan_can.php" class="form-horizontal" name="from1" method="post" enctype="multipart/form-data" >
                <br /><div class="form-group">
                  <input type="hidden" class="form-control" name="exam_id" value="<?php echo $exam_id; ?>" />
                  <input type="hidden" class="form-control" name="send_random" value="<?php echo ' '; ?>" />
                ...
                <div class="form-group">
                  <div class=" col-sm-12">
                    ...
                    name="uploadExam" style="" value="submit">ยกเลิกข้อสอบ</button>
                  </div>
                </div>
              </form>
